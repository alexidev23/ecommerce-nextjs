      ...
      <div className="flex flex-col w-[1000px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 items-start">
          ...
          <div className="bg-white rounded-xl shadow-xl p-7">
            ...
            <div className="mb-10">
              <p className="text-xl">Alexis Esocar</p>
              <p>Calle viva 23</p>
              <p>Cura Brochero</p>
              <p>Cordoba</p>
              <p>CP 5000</p>
            ...
            <div className="mt-5 mb-2 w-full ">
              <p className="mb-5">
                ...
                <span className="text-xs">
                  Al hacer click en `Colocar orden`, aceptas nuestros <a href="#" className="underline">terminos y condiciones de uso</a> y <a href="#" className="underline">politica de privacidad</a>
                </span>
              </p>
              <Link 
                href='/orders/123'
